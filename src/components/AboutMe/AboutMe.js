      ...
      <div className="aboutme__container">
        <div className="aboutme__text-block">
          ...
          <p className="aboutme__text">
            ...
            интересовалась искусством и дизайном. Сейчас мне очень интересно
            заглянуть дизайну "под капот", поэтому я закончила курс
            Яндекс.Практикума по веб-разработке и спешу ворваться в новую
            профессию. А еще я мама мальчиков-близнецов и они здорово задают
            темп всех моих дел.
          </p>
          <a
